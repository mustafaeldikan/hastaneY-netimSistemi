...
public class deleteDoctor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        dDeleteField.setText("DR-");
        dDeleteField.setToolTipText("");
    ...
    private void jPanel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel1MouseClicked
        ...
        try {
            ps = connection.prepareStatement(sql);
            ps.execute();
            JOptionPane.showMessageDialog(null, "Doctor has id " + search + " has been deleted");
            defaultTableModel.getDataVector().removeAllElements();
            defaultTableModel.fireTableDataChanged();
            loadData();
            connection.close();
        } catch (SQLException e) {
            JOptionPane.showMessageDialog(null, "Doctor has id " + search + " not found");
        }
